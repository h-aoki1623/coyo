"""Middleware and exception handlers for the Coto API."""
...
async def coto_error_handler(request: Request, exc: CotoError) -> JSONResponse:
    """Centralized handler for all CotoError exceptions.
